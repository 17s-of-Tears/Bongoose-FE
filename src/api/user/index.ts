...
// 프로필 수정
const updateUser = (payload: ReqUserInfo | FormData, type: 'form' | 'body') => {
	return type === 'form' ? user.put(`me`, payload, formDataConfig) : user.put(`me`, payload)
}

// 유저 정보 가져오기
const getUsers = (payload: AxiosRequestConfig<ReqUserSearchInfo>): AxiosPromise<ResUserSearchInfo> =>
	user.get('/', payload)
